...
def load_data(n: str, SOS: str = '[', EOS: str = ']'):
    df = pd.read_csv(n)
...
def create_batch(all_names: list, probs_list: list, batch_size: int,
                 vocab: dict, SOS: str, EOS: str):
